param(
    ...
    [string]$Repo = "https://github.com/RossDmello2/finimatic-email-ops",
    ...
    [string]$FrontendUrl = "https://finimatic-frontend.vercel.app/",
    [string]$GmailOAuthRedirectUri = "https://finimatic-backend.onrender.com/api/settings/gmail-api/oauth/callback",
...
$args = @(
    ...
    "--env-var", "GMAIL_OAUTH_REDIRECT_URI=$GmailOAuthRedirectUri",
